...
//		TV tv = (TV) context.getBean(LgTV.class);   // LgTV를 명시적으로 찾기 
		...
		TV tv = (TV) context.getBean(SamsungTV.class);   // 세터 인젝션 형태로 주입 !!! ( No qualifying bean of type 'net.developia.spring01.di201.Speaker' available: expected single matching bean but found 2: harmanSpeaker,marshallSpeaker)
